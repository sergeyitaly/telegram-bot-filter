...
| telegram-bot-filter | `**/*` | Expert context for this specific codebase — keyword patterns, alarm lifecycle, Redis state, handler architecture, security rules, common task recipes, and known attack surface. Auto-triggered on every task in this repo. |
